...
{
    class dkOstrosłupCzworokątnyPochyły : dkWielościany
    {//deklaracja zmiennych globalnych dla danej klasy
        ...
        public dkOstrosłupCzworokątnyPochyły(int dkR, int dkWysokośćOstrosłupa, int dkStopieńWielokątaPodstawy, int dkXsS,
            int dkYsS, int dkXsP, int dkYsP,
        ...
        {//odziedziczenie wartości zmiennych z klasy nadrzędnej
            this.dkrodzaj_bryły = dktyp_bryły.dkbg_ostrosłup_czworokątny_pochyły;
