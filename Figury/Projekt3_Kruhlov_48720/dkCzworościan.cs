...
{
    class dkCzworościan : dkWielościany
    {
        ...
        public dkCzworościan(int dkR, int dkWysokośćOstrosłupa, int dkStopieńWielokątaPodstawy, int dkXsS, int dkYsS, int dkXsP, int dkYsP,
        ...
        {//odziedziczenie wartości zmiennych z klasy nadrzędnej
            this.dkrodzaj_bryły = dktyp_bryły.dkbg_czworościan;
