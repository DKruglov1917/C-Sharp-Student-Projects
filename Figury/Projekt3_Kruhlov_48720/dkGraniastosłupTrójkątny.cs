...
{
    class dkGraniastosłupTrójkątny : dkWielościany
    {//deklaracja zmiennych globalnych dla danej klasy
        ...
        public dkGraniastosłupTrójkątny(int dkR, int dkWysokośćOstrosłupa, int dkStopieńWielokątaPodstawy, int dkXsS, int dkYsS,
            int dkXsP, int dkYsP,
        ...
        {//odziedziczenie wartości zmiennych z klasy nadrzędnej
            this.dkrodzaj_bryły = dktyp_bryły.dkbg_graniastosłup_trójkątny;
            ...
            this.dkPowierzchniaBryły = (dkPolePodstawy * 2 + dkPoleBoku * 3);
        }
