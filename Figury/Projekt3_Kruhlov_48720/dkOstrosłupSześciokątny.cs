...
{
    class dkOstrosłupSześciokątny : dkWielościany
    {//deklaracja zmiennych globalnych dla danej klasy
        ...
        public dkOstrosłupSześciokątny(int dkR, int dkWysokośćOstrosłupa, int dkStopieńWielokątaPodstawy, int dkXsS, int dkYsS,
            int dkXsP, int dkYsP,
        ...
        {//odziedziczenie wartości zmiennych z klasy nadrzędnej
            this.dkrodzaj_bryły = dktyp_bryły.dkbg_ostrosłup_sześciokątny;
